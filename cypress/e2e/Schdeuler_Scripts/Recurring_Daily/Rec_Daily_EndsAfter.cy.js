describe('CreatePackage_Uploadfile',() => {
    it("uploadfle_Ingestion",()=>  {
        ...
        cy.get('#mat-input-2').type('Scheduler_Pack_106')
        ...
        //daily click
        cy.get('#mat-option-289 > .mat-option-text').click()
    ...
    //after again
    cy.get('#mat-input-2').scrollIntoView().clear().type('Scheduler_Pack_109')  //-change the name
