describe('CreatePackage_Uploadfile',() => {
    it("Repeat_Every_1_Days",()=>  {
        ...
        cy.get('#mat-input-2').type('Repeat_Every_1_Days_101')
     ...
     it.only("Repeat_Every_1_Days_endsAfter",()=>  {
        cy.viewport(1352,591)
        cy.visit("http://qaapp.swiftdata.ai/login")
         // Set viewport to 550px x 750px
        cy.get("[formcontrolname='email']").type("azharuddin.mohammad@amnetdigital.com")
        ...
        cy.contains('pkg_auto_package_237').click()
        //need to chenge everytime
        cy.get('#mat-input-2').type('Repeat_Every_1_Days_endsAfter_401')
        cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
        // cy.get('#time-select-panel').scrollIntoView
        cy.get('#mat-option-223 > .mat-option-text').scrollIntoView().click()
        //Frequncy selection
       ...
       //date selection click
        ...
        cy.get('.d-flex > .mat-focus-indicator').click()
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('Repeat_Every_1_Days_endsAfter_301')  //-change the name
     ...
     it("Repeat_Every_2_Days_EndsOn",()=>  {
        ...
        cy.contains('pkg_auto_package_237').click()
        //need to chenge everytime
        cy.get('#mat-input-2').type('Repeat_Every_2_Days_EndsOn_101')
        cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
        // cy.get('#time-select-panel').scrollIntoView
        cy.get('#mat-option-223 > .mat-option-text').scrollIntoView().click()
        //Frequncy selection
     ...
     it("Repeat_Every_2_Days_endsAfter",()=>  {
        cy.viewport(1352,591)
        cy.visit("http://qaapp.swiftdata.ai/login")
         // Set viewport to 550px x 750px
        cy.get("[formcontrolname='email']").type("azharuddin.mohammad@amnetdigital.com")
        ...
        cy.contains('pkg_auto_package_237').click()
        //need to chenge everytime
        cy.get('#mat-input-2').type('Repeat_Every_1_Days_endsAfter_101')
        cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
        // cy.get('#time-select-panel').scrollIntoView
        cy.get('#mat-option-223 > .mat-option-text').scrollIntoView().click()
        //Frequncy selection
       ...
       //date selection click
        ...
        cy.get('.d-flex > .mat-focus-indicator').click()
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('Repeat_Every_1_Days_endsAfter_201')  //-change the name
         cy.get('#mat-input-8').clear().type("2")
         cy.get('.save-btn').scrollIntoView().click()
         cy.get('.d-flex > .mat-focus-indicator').click()
        //verify that schedule is done
