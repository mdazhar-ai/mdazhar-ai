describe('CreatePackage_Uploadfile',() => {
    it("uploadfle_Ingestion",()=>  {
        ...
        cy.get('#mat-input-2').type('AnuallyOnAdayEndsafter_005')
        ...
        cy.get('#mat-option-292 > .mat-option-text').click()
       ...
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('AnuallyOnAdayEndsafter_006')  //-change the name
