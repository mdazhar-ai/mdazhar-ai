describe('CreatePackage_Uploadfile',() => {
    it("uploadfle_Ingestion",()=>  {
        ...
        cy.get('#mat-input-2').type('Scheduler_Packged_240')
        ...
        cy.get('#mat-option-290 > .mat-option-text').click()
       ...
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('Scheduler_Packged_241')  //-change the name
