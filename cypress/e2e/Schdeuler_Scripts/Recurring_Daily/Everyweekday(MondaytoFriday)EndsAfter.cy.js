describe('CreatePackage_Uploadfile',() => {
    it("uploadfle_Ingestion",()=>  {
        ...
        cy.get('#mat-input-2').type('Everyweekday(MondaytoFriday)EndsAfter.cy_001')
        ...
        cy.get('#mat-option-293 > .mat-option-text').click()
       ...
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('Everyweekday(MondaytoFriday)EndsAfter_241')  //-change the name
