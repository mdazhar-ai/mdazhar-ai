describe('LOGINSD',() => {
    it("Repeat_Every_1_WEEK _Ends on Date",()=>  {
        ...
        cy.get('#mat-input-2').type('Repeat_Every_1_WEEK___008')
        ...
        //click on weeks
        cy.get('#mat-option-301 > .mat-option-text').click()
        //cy.get('#mat-option-300 > .mat-option-text').click()

        cy.get(':nth-child(1) > .mx-1').click()
        cy.get(':nth-child(3) > .mx-1').click()
        cy.get(':nth-child(5) > .mx-1').click()
        cy.get(':nth-child(5) > .mx-1').click()
     ...
     it("Repeat_Every_1_WEEK _Ends after occurance",()=>  {
        cy.viewport(1352,591)
        cy.visit("http://qaapp.swiftdata.ai/login")
         // Set viewport to 550px x 750px
        cy.get("[formcontrolname='email']").type("azharuddin.mohammad@amnetdigital.com")
        ...
        cy.contains('pkg_auto_package_237').click()
        //need to chenge everytime
        cy.get('#mat-input-2').type('Repeat_Every_1_Days_endsAfter_409')
        cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
        // cy.get('#time-select-panel').scrollIntoView
        cy.get('#mat-option-223 > .mat-option-text').scrollIntoView().click()
        //Frequncy selection
       ...
       //date selection click
        ...
        cy.get('.d-flex > .mat-focus-indicator').click()
       //after again
         cy.get('#mat-input-2').scrollIntoView().clear().type('Repeat_Every_1_Days_endsAfter_308')  //-change the name
    ...
    it("Repeat_Every_2_WEEK _Ends on Date",()=>  {
            cy.viewport(1352,591)
            cy.visit("http://qaapp.swiftdata.ai/login")
             // Set viewport to 550px x 750px
            cy.get("[formcontrolname='email']").type("azharuddin.mohammad@amnetdigital.com")
            ...
            //need to chenge everytime
            cy.get('#mat-input-2').type('Repeat_Every_2_WEEK___007')
            cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
    ...
    it("Repeat_Every_2_WEEK _Ends after occurance",()=>  {
            cy.viewport(1352,591)
            cy.visit("http://qaapp.swiftdata.ai/login")
             // Set viewport to 550px x 750px
            cy.get("[formcontrolname='email']").type("azharuddin.mohammad@amnetdigital.com")
            ...
            cy.contains('pkg_auto_package_237').click()
            //need to chenge everytime
            cy.get('#mat-input-2').type('Repeat_Every_2_weeks_endsAfter_408')
            cy.get('#time-select > .mat-select-trigger > .mat-select-arrow-wrapper > .mat-select-arrow').click()
            // cy.get('#time-select-panel').scrollIntoView
            cy.get('#mat-option-223 > .mat-option-text').scrollIntoView().click()
            //Frequncy selection
           ...
           //date selection click
            ...
            cy.get('.d-flex > .mat-focus-indicator').click()
           //after again
             cy.get('#mat-input-2').scrollIntoView().clear().type('Repeat_Every_2_weeks_endsAfter_308')  //-change the name
