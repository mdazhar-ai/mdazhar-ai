describe('CreatePackage_Uploadfile',() => {
    it("UploadFIle_Ingestion",()=>  {
        ...
        cy.get('#mat-input-2').type('Scheduler_Packged_101')
        ...
        // cy.get('#time-select-panel').scrollIntoView
         ...
         cy.get('#timezon-select > .ng-select-container').click() //timezoneclick
         cy.get('.ng-dropdown-panel-items').scrollIntoView()
         cy.get('.ng-option.ng-option-selected.ng-option-marked.ng-star-inserted').click()
